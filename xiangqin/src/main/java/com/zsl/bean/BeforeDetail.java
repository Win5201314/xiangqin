...
public class BeforeDetail extends BmobObject implements Serializable {
    ...
    public BeforeDetail(String name, String sex, String phone, String imageUrl, String birthday,
